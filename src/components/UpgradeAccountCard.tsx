    ...
    <div className="relative overflow-visible mb-4 w-full">
      <div className="rainbow-border">
        <div className="bg-white rounded-lg p-4 flex flex-col items-center text-center relative z-20">
          ...
          <h3 className="text-[16px] font-bold text-gray-900 whitespace-nowrap">Upgrade your account</h3>
          <p className="text-[14px] text-gray-600 mb-4 whitespace-nowrap">Get access to all premium features</p>
          <Button 
