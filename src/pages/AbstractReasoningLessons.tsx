                        ...
                        <CardContent className="p-4 md:p-6">
                          <div className="flex items-center gap-3 mb-3 md:mb-4">
                            ...
                            <div>
                              ...
                              <p className="text-sm md:text-base text-blue-700">Elliot can explain concepts, provide pattern analysis tips, and answer questions about {lesson.title.toLowerCase()}.</p>
                            </div>
                          </div>
